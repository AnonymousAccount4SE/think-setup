...
@SolrDocument(solrCoreName = "Orders")
...
public class Document2 {
	...
	@Id
	  ...
	  public Document2(String id, String docType, String docTitle){
	    this.id = id;
	    this.docTitle = docTitle;
	    this.docType = docType;
	  }
	  
	  public Document2(String id, String docType, String docTitle,  Object thinkObject){
		    this.id = id;
		    this.docTitle = docTitle;
		    this.docType = docType;
