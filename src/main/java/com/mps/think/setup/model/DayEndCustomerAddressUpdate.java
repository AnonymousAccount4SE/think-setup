...
@Entity
@Table(name = "day_end_customer_address_update")
public class DayEndCustomerAddressUpdate extends BaseEntity {
	...
	private String jobName = "Customer Address Update";
	...
	public String toString() {
		return "DayEndCustomerAddressUpdate [id=" + id + ", jobName=" + jobName + ", every=" + every + ", intervalUnit="
