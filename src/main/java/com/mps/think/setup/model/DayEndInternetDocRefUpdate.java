...
@Entity
@Table(name = "day_end_internet_doc_ref_update")
public class DayEndInternetDocRefUpdate extends BaseEntity {
	...
	private String jobName = "Internet Doc Ref Update";
	...
	public String toString() {
		return "DayEndInternetDocRefUpdate [id=" + id + ", jobName=" + jobName + ", every=" + every + ", intervalUnit="
