...
@Entity
@Table(name = "day_end_suspend_reinstate")
public class DayEndSusRein extends BaseEntity {
	...
	private String jobName = "Suspend/Reinstate";
	...
	public String toString() {
		return "DayEndSusRein [id=" + id + ", jobName=" + jobName + ", every=" + every + ", intervalUnit="
