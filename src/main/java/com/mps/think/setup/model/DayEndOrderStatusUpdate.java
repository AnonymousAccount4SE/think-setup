...
@Entity
@Table(name = "day_end_order_status_update")
public class DayEndOrderStatusUpdate extends BaseEntity {
	...
	private String jobName = "Order Status Update";
	...
	public String toString() {
		return "DayEndOrderStatusUpdate [id=" + id + ", jobName=" + jobName + ", every=" + every + ", intervalUnit="
