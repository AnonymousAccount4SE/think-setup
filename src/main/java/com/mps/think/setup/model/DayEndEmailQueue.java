...
@Entity
@Table(name = "day_end_email_event_queue")
public class DayEndEmailQueue extends BaseEntity {
	...
	private String jobName = "Email/Event Queue";
	...
	public String toString() {
		return "DayEndEmailQueue [id=" + id + ", jobName=" + jobName + ", every=" + every + ", intervalUnit="
